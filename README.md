...
## Switch to the image from a bootc system and reboot

```bash
sudo bootc switch ghcr.io/iAlexanderMoon/umoon-labwc
```

# Disk Images
* Builds disk images (ISO, qcow)

_NOTE _
* There are two files in the iso.
* raw doesn't seem supported

## Build Artifacts
* build artifacts available in the build
* download build artifact.zip from job summary
